...
E5_EMBEDDING_PROMPTS = {
    ...
    "cure_human_annotations": "Given a search query, retrieve relevant passages that answer the query",
}
...
MEDICAL_DATASETS = ["cure_human_annotations"]

class E5CureData(Dataset):
    def __init__(
        self,
        dataset_name: str = "E5Cure",
