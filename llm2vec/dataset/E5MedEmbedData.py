...
E5_EMBEDDING_PROMPTS = {
    ...
    "medembed_data": "Given a search query, retrieve relevant medical notes that can help answer the query",
}
...
MEDICAL_DATASETS = ["medembed_data"]

class E5MedEmbedData(Dataset):
    def __init__(
        self,
        dataset_name: str = "E5MedEmbed",
